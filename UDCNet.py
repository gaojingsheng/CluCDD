...
if __name__ == "__main__":
    ...
    if args.dataset == "dialogue":
        all_utterances, labels = utils.read_data(datapath="../dataset/entangled_train.json", mode='train')
        dev_utterances, dev_labels = utils.read_data(datapath="../dataset/entangled_dev.json", mode='dev')
    elif args.dataset == "irc":
        savename += "_IRC"
        args.num_labels = 14
        all_utterances, labels = utils.read_data(datapath="../dataset/irc_dialogue/irc50_train_delete.json", mode='train')
        dev_utterances, dev_labels = utils.read_data(datapath="./dataset/irc_dialogue/irc50_dev_delete.json", mode='dev')
    else:
